...
namespace Regressus.Projectiles.Melee
{
    public class BloodRapierP : ModProjectile
    {
        ...
        {
            Projectile proj = Main.projectile[Projectile.NewProjectile(Projectile.GetItemSource_FromThis(), Projectile.Center, Projectile.velocity * 7.5f, ProjectileID.BloodNautilusShot, Projectile.damage, Projectile.knockBack, Main.player[Projectile.owner].whoAmI)];
            proj.friendly = true;
            proj.hostile = false;
            proj.penetrate = 1;
        }
