        ...
        public override void AI()
        {
            ...
            */
            ...
            if (Projectile.ai[1] == 1)
            {
                ...
                if (AITimer == 50)
                {
                    if (attacks < 3)
                    {
                        attacks++;
                        AITimer = 0;
                        Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, 1.5f * Utils.RotatedBy(Projectile.DirectionTo(player.Center), 0), ModContent.ProjectileType<OracleBlast>(), 45, 0, player.whoAmI, 1);
                        Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, 1.5f * Utils.RotatedBy(Projectile.DirectionTo(player.Center), 0), ModContent.ProjectileType<OracleTelegraphLine>(), 0, 0, player.whoAmI);
                    }
                    else
                    {
                        lastPos = player.Center;
                        Projectile proj = Main.projectile[Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, 1.5f * Utils.RotatedBy(Projectile.DirectionTo(player.Center), 0), ModContent.ProjectileType<OracleTelegraphLine>(), 0, 0, player.whoAmI)];
                        proj.timeLeft = 25;
                    }
                }
                if (AITimer >= 75)
                {
                    ...
                    Projectile proj = Main.projectile[Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, 1.5f * Utils.RotatedBy(Projectile.DirectionTo(lastPos), 0), ModContent.ProjectileType<OracleBeam>(), 45, 0, player.whoAmI, 2)];
                    proj.timeLeft = 20;
                    AITimer = 0;
                }
            }
            ...
            /*if (Projectile.ai[1] == 4)
            {
                ...
                if (AITimer == 20)
                    for (int i = -1; i <= 1; i += 2)
                    {
                        ...
                        Projectile projectile = Main.projectile[Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, 1.5f * vel, ModContent.ProjectileType<OracleBeam>(), 45, 0, player.whoAmI, 2)];
            ...
            /*if (Projectile.ai[1] == 2)
            {
                ...
                {
                    AITimer = 0;
                    Projectile.NewProjectile(Projectile.GetProjectileSource_FromThis(), Projectile.Center, .5f * Utils.RotatedBy(Projectile.DirectionTo(player.Center), 0), ModContent.ProjectileType<OracleOrbs2>(), 45, 0, player.whoAmI, 1);
                }
            }
            else
            {
