...
namespace Regressus.Projectiles.Oracle
{
    public class OracleBeamTarget : ModProjectile
    {
        ...
        public Texture2D TrailTexture1 = ModContent.Request<Texture2D>("Regressus/Extras/oracleBeam").Value;
        public Texture2D TrailTexture2 = ModContent.Request<Texture2D>("Regressus/Extras/Tentacle").Value;
        public Texture2D TrailTexture3 = ModContent.Request<Texture2D>("Regressus/Extras/laser").Value;
        float rotation;
